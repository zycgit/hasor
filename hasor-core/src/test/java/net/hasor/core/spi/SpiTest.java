...
public class SpiTest {
    ...
    public void awareTest1() {
        ...
        AppContext appContext = Hasor.create().build(apiBinder -> {
            assert aware1 == HasorUtils.autoAware(apiBinder.getEventContext(), aware1);
            Supplier<AppContextAware> awareSupplier = () -> aware2;
            assert awareSupplier == HasorUtils.autoAware(apiBinder.getEventContext(), awareSupplier);
        });
        //
    ...
    public void startListenerTest1() {
        ...
        //
        AppContext appContext = Hasor.create().build(apiBinder -> {
            assert listener1 == HasorUtils.pushStartListener(apiBinder.getEventContext(), listener1);
            BindInfo<EventListener> bindInfo = apiBinder.bindType(EventListener.class).toInstance(listener2).toInfo();
            assert bindInfo == HasorUtils.pushStartListener(apiBinder.getEventContext(), bindInfo);
        });
        //
    ...
    public void stopListenerTest1() {
        ...
        //
        AppContext appContext = Hasor.create().build(apiBinder -> {
            assert listener1 == HasorUtils.pushShutdownListener(apiBinder.getEventContext(), listener1);
            BindInfo<EventListener> bindInfo = apiBinder.bindType(EventListener.class).toInstance(listener2).toInfo();
            assert bindInfo == HasorUtils.pushShutdownListener(apiBinder.getEventContext(), bindInfo);
        });
        //
