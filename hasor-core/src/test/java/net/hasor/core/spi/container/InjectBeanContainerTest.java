...
//        //
//        // 使用系统默认构造方法
//        Constructor<ConstructorBeanByInjectSettingConfValue> constructor = (Constructor<ConstructorBeanByInjectSettingConfValue>) ConstructorBeanByInjectSettingConfValue.class.getConstructors()[0];
//        ConstructorBeanByInjectSettingConfValue injectConstructor = appContext.getInstance(constructor);
//        //
