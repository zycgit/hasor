...
public class WebServerConfigTest {
    ...
    public void configNamespaceOverridesLegacyBootOptions() {
        Settings settings = Hasor.create().addSettings(Settings.DefaultNameSpace, "hasor.boot.web.staticLocation", "legacy").addSettings(Settings.DefaultNameSpace, "hasor.config.web.staticLocation", "current").addSettings(Settings.DefaultNameSpace, "hasor.boot.web.scanExcludes", "example.Legacy").addSettings(Settings.DefaultNameSpace, "hasor.config.web.scanExcludes", "example.Current").buildSettings();
