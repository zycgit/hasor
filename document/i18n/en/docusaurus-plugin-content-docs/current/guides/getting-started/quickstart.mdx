...
The following examples use Hasor `@project.docsVersion@`.
...
Start Web Boot applications with `WebServers.run(args, RootModule.class)`. See [Boot Startup](../deployment/overview.md), [Project Configuration](../deployment/project-config.md), and [Web Launcher](../deployment/web-launcher.md).
