...
public class MappingBinderTest extends AbstractTest {
    ...
    public void mappingTest_1() {
        ...
        final Supplier<AnnoGetAction> testCallerActionProvider = () -> testCallerAction;
        //
    ...
    public void filterTest_1() throws Throwable {
        ...
        final Supplier<SimpleInvokerFilter> testCallerFilterProvider = () -> testCallerFilter;
        //
        AppContext appContext = buildWebAppContext(apiBinder -> {
    ...
    public void servletTest_1() {
        ...
        final Supplier<SimpleServlet> testCallerServletProvider = () -> testCallerServlet;
        //
        AppContext appContext = buildWebAppContext(apiBinder -> {
